# Target (ESP32-C3) awareness helpers for gdb OS-awareness (ASP3).
#
# pico2_riscv_gcc版からの流用。
#
# 役割: ターゲット（ボード）依存の知識。本ボードはチップ(ESP32-C3/INTMTX)の
#       機能をそのまま使い，現時点でボード固有の追加項目は無いため，
#       chip_os_awareness の API を再エクスポートする。
#
# chip_os_awareness.py は arch/riscv_gcc/esp32c3 にあるため，本ファイルからの
...
sys.path.insert(0, os.path.normpath(
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../arch/riscv_gcc/esp32c3")))
