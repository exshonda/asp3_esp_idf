...
| チップ | DUT | IP取得 | ping |
|---|---|---|---|
| C3 | `60:55:F9:57:C2:60` | 192.168.1.77 | gateway ping 継続成功（evidence-c3-11） |
| C6 | `14:C1:9F:E0:61:B0` | 192.168.1.78 | gateway ping 継続成功 |
| C5 | `D0:CF:13:F0:C8:94` | 192.168.1.79 | gateway ping 継続成功 |
