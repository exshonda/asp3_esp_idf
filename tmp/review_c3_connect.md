...
対象: リポジトリ `$HOME/asp3_esp_idf`、ブランチ `claude/c6-wifi-c5-dev-5vc6x9`（HEAD=`36c99f7`）。
...
1. まず環境要因の切り分けを完了する（メモ記載の手順どおり）：
   a. BlueZ側で `bluetoothctl remove <MAC-21>` → 電源再投入（DUT）→ `scan on` →
      `connect`。
...
- `$HOME/asp3_esp_idf/apps/ble_host_smoke/ble_host_smoke.c`
- `$HOME/asp3_esp_idf/apps/ble_host_smoke/ble_host_smoke.cfg`
- `$HOME/asp3_esp_idf/asp3/target/esp32c3_espidf/esp_bt.cmake`
- `$HOME/asp3_esp_idf/asp3/target/esp32c3_espidf/bt/stub/include/bt_nimble_config.h`
- `$HOME/asp3_esp_idf/asp3/target/esp32c3_espidf/wifi/esp_shim.c`(+`.h`)
- `$HOME/asp3_esp_idf/asp3/target/esp32c5_espidf/bt/stub/include/bt_nimble_config.h`
- `$HOME/asp3_esp_idf/asp3/target/esp32c5_espidf/wifi_v8/esp_shim.c`
- `$HOME/asp3_esp_idf/hal/components/bt/host/nimble/nimble/nimble/host/src/ble_gap.c`
- `$HOME/asp3_esp_idf/hal/components/bt/host/nimble/nimble/nimble/host/src/ble_hs_id.c`
- `$HOME/asp3_esp_idf/hal/components/bt/host/nimble/nimble/nimble/host/src/ble_hs_pvcy.c`
- `$HOME/asp3_esp_idf/hal/components/bt/host/nimble/nimble/nimble/host/src/ble_hs_resolv.c`
- `$HOME/asp3_esp_idf/hal/components/bt/host/nimble/nimble/nimble/host/src/ble_hs_startup.c`
- `$HOME/asp3_esp_idf/hal/components/bt/host/nimble/nimble/nimble/host/store/config/src/ble_store_config.c`
- `$HOME/asp3_esp_idf/docs/bt-shim.md`（該当区間の記録全て）
