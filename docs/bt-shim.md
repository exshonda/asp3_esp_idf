...
| ファイル | 内容 |
|---|---|
| `asp3/target/esp32c3_espidf/bt/phy_cal_trace.c` | （新規・診断）RF-cal regi2cトレース．`--wrap phy_get_romfuncs`でg_phyFuns regi2c枠差替え．option `ESP32C3_BT_PHY_CAL_TRACE`(既定OFF)時のみ |
